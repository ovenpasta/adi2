# Adi2 Individual Contributor License Agreement

Thank you for your interest in contributing to Adi2, a project of **Aldo
Nicolas Bruno** ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please sign it and
send it to Us by mail, email, fax, or electronic submission, following
the instructions in
[CONTRIBUTING.md](CONTRIBUTING.md#accepting-the-agreement). This is a
...
instructions in
[CONTRIBUTING.md](CONTRIBUTING.md#third-party-material-in-a-contribution).
...
Contribution: Creative Commons Attribution 4.0 International (CC BY 4.0)
(including any right to adopt any future version of a license if
permitted).
...
the laws of **Portugal** excluding its conflicts
...
(HA-CLA-I), Version 1.0, July 4 2011, developed by
[Project Harmony](https://www.harmonyagreements.org/) and licensed under
a [Creative Commons Attribution 3.0 Unported
License](https://creativecommons.org/licenses/by/3.0/).

Adopter choices made in this copy, all of which the template invites:
copyright **license** rather than assignment; outbound license
**Option Five**; Media licensed under **CC BY 4.0**; the bracketed
"or Your Affiliates" in Section 2.2 omitted as inapplicable to an
individual. The substantive wording is otherwise unaltered.
