...
package body Dialog_Example_Styles is
   ...
   procedure Register_Selectors_7
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("backdrop", Backdrop_Class_Part_Styles));
   ...
   procedure Register_Selectors_11
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("button-row", Button_Row_Class_Part_Styles));
   ...
   procedure Register_Selectors_13
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("dialog-btn-primary", Dialog_Btn_Primary_Class_Part_Styles));
   ...
   procedure Register_Selectors_14
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("custom-content", Custom_Content_Class_Part_Styles));
   ...
   procedure Register_Selectors_15
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("detail-label", Detail_Label_Class_Part_Styles));
