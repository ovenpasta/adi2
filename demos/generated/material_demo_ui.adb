...
package body Material_Demo_UI is
   ...
   function Build
      ...
      Label_3 : constant Adi.Widget.Label.Label_Handle := Adi.Widget.Label.Create_Handle (Adi.I18N.T ("Edit demos/css/material_demo.css to live-reload."));
   ...
   begin
      ...
      begin
         ...
         Adi.CSS_Source.Set_Dynamic_Sources
           (Source,
            [Adi.CSS_Source.CSS_File ("demos/css/material_demo.css")],
            Loaded);
         if Loaded then
            Adi.CSS_Source.Set_Mode
              (Source, Adi.CSS_Source.Dynamic_Mode, Mode_OK);
