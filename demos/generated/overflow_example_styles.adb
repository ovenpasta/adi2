...
package body Overflow_Example_Styles is
   ...
   procedure Register_Selectors_7
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("clip-visible", Clip_Visible_Class_Part_Styles));
   ...
   procedure Register_Selectors_8
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("clip-hidden", Clip_Hidden_Class_Part_Styles));
   ...
   procedure Register_Selectors_9
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("content-stack", Content_Stack_Class_Part_Styles));
   ...
   procedure Register_Selectors_10
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("long-line", Long_Line_Class_Part_Styles));
   ...
   procedure Register_Selectors_11
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("wrap-line", Wrap_Line_Class_Part_Styles));
   ...
   procedure Register_Selectors_12
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("item-a", Item_A_Class_Part_Styles));
   ...
   procedure Register_Selectors_13
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("item-b", Item_B_Class_Part_Styles));
   ...
   procedure Register_Selectors_14
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("item-c", Item_C_Class_Part_Styles));
   ...
   procedure Register_Selectors_15
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("item-d", Item_D_Class_Part_Styles));
