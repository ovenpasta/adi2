...
package body Svg_Example_Styles is
   ...
   procedure Register_Selectors_7
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("stage", Stage_Class_Part_Styles));
   ...
   procedure Register_Selectors_8
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("artwork", Artwork_Class_Part_Styles));
