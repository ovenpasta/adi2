...
package body Value_Input_Example_Styles is
   ...
   procedure Register_Selectors_6
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("label-narrow", Label_Narrow_Class_Part_Styles));
   ...
   procedure Register_Selectors_9
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("int-input", Int_Input_Class_Part_Styles));
   ...
   procedure Register_Selectors_10
     (S : in out Adi.CSS_Source.Style_Source) is
   begin
      Adi.CSS_Source.Add_Static_Entry (S, Adi.CSS_Source.Class_Entry ("wide-input", Wide_Input_Class_Part_Styles));
