...
procedure RLottie_Example is
   ...
   begin
      if Ada.Directories.Exists ("demos/assets/" & File) then
         return "demos/assets/" & File;
      elsif Ada.Directories.Exists ("assets/" & File) then
         return "assets/" & File;
      elsif Ada.Directories.Exists ("../demos/assets/" & File) then
         return "../demos/assets/" & File;
      else
         return "demos/assets/" & File;
      end if;
   ...
   begin
      ...
      if Loaded = 0 then
         Adi.Widget.Label.Set_Text
           (Status, "FAILED TO LOAD demos/assets/noto_*.json");
      else
         Adi.Widget.Label.Set_Text
           (Status,
