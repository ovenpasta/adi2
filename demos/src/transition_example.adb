...
--  Every button's transition and hover live in demos/css/transition_example.css, editable while the program runs.
...
begin
   ...
   declare
      OK : Boolean;
   begin
      UI.Set_CSS_File ("demos/css/transition_example.css", OK);
      if not OK then
