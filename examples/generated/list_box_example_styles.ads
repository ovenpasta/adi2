...
package List_Box_Example_Styles is
   ...
   --  Style for label-row when State_Selected
   Label_Row_Selected_Style : constant Style_Rules := (
   ...
   --  Style for label-row::label when State_Selected
   Label_Row_Label_Selected_Style : constant Style_Rules := (
      Color => Set (C (White)),
      others => <>
   );
   ...
   --  Style for card-row when State_Selected
   Card_Row_Selected_Style : constant Style_Rules := (
   ...
   Card_Row_Widget : constant Widget_Style :=
     ...
     .On (When_State (State_Selected), Card_Row_Selected_Style)
     .Build;
