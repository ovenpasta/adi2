...
package Material_Demo_Light_Styles is
   ...
   Card_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Background (RGB (255, 255, 255))
        .Gap (Gap (Dip (12.0)))
        .Box_Shadow (Shadow (Dip (0.0), Dip (1.0), Dip (4.0), Dip (0.0), RGBA (0, 0, 0, 0.15)))
   ...
   Btn_Primary_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Box_Shadow (Shadow (Dip (0.0), Dip (1.0), Dip (3.0), Dip (0.0), RGBA (0, 0, 0, 0.15)))
     ...
     --  widget State_Hovered
     .On (When_State (State_Hovered))
        .Background (RGB (122, 100, 180))
        .Box_Shadow (Shadow (Dip (0.0), Dip (2.0), Dip (6.0), Dip (0.0), RGBA (0, 0, 0, 0.2)))
     --  widget State_Pressed
     .On (When_State (State_Pressed))
        .Background (RGB (85, 64, 140))
        .Box_Shadow (Shadow (Dip (0.0), Dip (0.0), Dip (2.0), Dip (0.0), RGBA (0, 0, 0, 0.1)))
     --  widget State_Focused
     .On (When_State (State_Focused))
        .Outline_Width (Dip (2.0))
        .Outline_Style (Outline_Solid)
        .Outline_Color (RGB (28, 27, 31))
        .Outline_Offset (Dip (2.0))
   ...
   Btn_Secondary_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Border_Color (Border_Color (RGB (121, 116, 126)))
        .Radius (Radius (Dip (999.0)))
     --  widget State_Hovered
     .On (When_State (State_Hovered))
        .Background (RGBA (103, 80, 164, 0.08))
        .Box_Shadow (Shadow (Dip (0.0), Dip (1.0), Dip (4.0), Dip (0.0), RGBA (0, 0, 0, 0.12)))
     --  widget State_Pressed
     .On (When_State (State_Pressed))
   ...
   Text_Field_Class_Widget : constant Widget_Style :=
     ...
     --  widget State_Focused
     .On (When_State (State_Focused))
        .Border_Color (Border_Color (RGB (103, 80, 164)))
     --  widget State_Disabled
     .On (When_State (State_Disabled))
        .Opacity (0.5)
        .Cursor_Style (Cursor_Default)
   ...
   Combo_Class_Widget : constant Widget_Style :=
     ...
     --  widget State_Hovered
     .On (When_State (State_Hovered))
        .Box_Shadow (Shadow (Dip (0.0), Dip (0.0), Dip (8.0), Dip (0.0), RGBA (103, 80, 164, 0.12)))
        .Border_Color (Border_Color (RGB (103, 80, 164)))
     --  widget State_Focused
     .On (When_State (State_Focused))
        .Box_Shadow (Shadow (Dip (0.0), Dip (0.0), Dip (10.0), Dip (0.0), RGBA (103, 80, 164, 0.4)))
        .Border_Width (Border_Width (Dip (0.0), Dip (0.0), Dip (2.0), Dip (0.0)))
        .Border_Color (Border_Color (RGB (103, 80, 164)))
     --  widget State_Disabled
     .On (When_State (State_Disabled))
   ...
   Combo_Dropdown_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Background (RGB (255, 255, 255))
        .Box_Shadow (Shadow (Dip (0.0), Dip (8.0), Dip (20.0), Dip (0.0), RGBA (0, 0, 0, 0.15)))
   ...
   Dialog_Panel_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Box_Shadow (Shadow (Dip (0.0), Dip (8.0), Dip (32.0), Dip (0.0), RGBA (0, 0, 0, 0.18)))
        .Padding (CSS_Box (Dip (24.0), Dip (24.0), Dip (24.0), Dip (24.0)))
   ...
   Context_Menu_Class_Widget : constant Widget_Style :=
     Style_Of
        ...
        .Background (RGB (255, 255, 255))
        .Box_Shadow (Shadow (Dip (0.0), Dip (8.0), Dip (24.0), Dip (0.0), RGBA (0, 0, 0, 0.15)))
