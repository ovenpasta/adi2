...
package body Material_Demo_UI is
   ...
   function Build
      ...
      Label_18 : constant Adi.Widget.Label.Label_Handle := Adi.Widget.Label.Create_Handle (Adi.I18N.T ("Notifications"));
      ...
      Label_19 : constant Adi.Widget.Label.Label_Handle := Adi.Widget.Label.Create_Handle (Adi.I18N.T ("Auto-save"));
      Switch_4 : constant Adi.Widget.Button.Switch.Switch_Handle := Adi.Widget.Button.Switch.Create_Handle (True);
      Label_20 : constant Adi.Widget.Label.Label_Handle := Adi.Widget.Label.Create_Handle (Adi.I18N.T ("Lock UI"));
   begin
      --  Create widgets
