...
package Slider_Example_Styles is
   ...
   Slider_Vertical_Class_Base_Style : constant Style_Rules := (
      Width => Set (Size (Px (20.0))),
   ...
   Slider_Vertical_Class_Indicator_Base_Style : constant Style_Rules := (
   ...
   Slider_Vertical_Class_Knob_Base_Style : constant Style_Rules := (
      Height => Set (Size (Px (20.0))),
      Background_Color => Set_Bg (RGB (205, 214, 244)),
      Border_Radius => Set (Radius (Pct (50.0))),
      others => <>
