...
procedure Widget_Handle_Test is
   ...
   ---------------------------------------------------------------------------
   --  Test: Bubble_Context_Menu walks parent chain without crash: Widget_Access(Get_Parent(...)) can raise PROGRAM_ERROR from the accessibility check on a local access value.
   ---------------------------------------------------------------------------
