...
generate_if_needed "$XML_DIR/demo_flex.xml" "Demo_Flex_UI"
generate_if_needed "$XML_DIR/demo_block.xml" "Demo_Block_UI"
generate_if_needed "$XML_DIR/grid_example.xml" "Grid_Example_UI"
generate_if_needed "$XML_DIR/transition_example.xml" "Transition_Example_UI"
