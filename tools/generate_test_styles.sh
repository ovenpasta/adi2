...
generate_if_needed "$CSS_DIR/grid_tracks.css" "$OUT_DIR/grid_tracks_styles.ads" "Grid_Tracks_Styles"
...
generate_if_needed "$CSS_DIR/css_wide_keywords.css" "$OUT_DIR/css_wide_keywords_styles.ads" "CSS_Wide_Keywords_Styles"
